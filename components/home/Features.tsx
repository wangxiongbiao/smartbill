...
export function Features() {
    return (
        <>
            ...
            <section className="bg-white py-5 md:py-7" data-purpose="feature-left-text">
                <div className="px-4 sm:px-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 items-center">
                        <div>
                            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-dark leading-snug tracking-tight">Get Paid Faster with Quick Invoice Payments</h2>
                            <p className="text-slate-600 mb-6 text-lg leading-relaxed">Send invoices with built-in payment links. Let your clients pay instantly via credit card, Apple Pay, or Google Pay directly from the invoice.</p>
                            <ul className="space-y-4">
                                <li className="flex items-start">
                                    ...
                                    <span className="text-slate-700 text-base">Accept fast and secure online payments</span>
                                </li>
                                <li className="flex items-start">
                                    <svg className="w-5 h-5 text-green-500 mr-3 mt-1 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M5 13l4 4L19 7" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg>
                                    <span className="text-slate-700 text-base">Automatic payment status tracking</span>
                                </li>
                                <li className="flex items-start">
                                    <svg className="w-5 h-5 text-green-500 mr-3 mt-1 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M5 13l4 4L19 7" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg>
                                    <span className="text-slate-700 text-base">Zero setup required to start collecting funds</span>
                                </li>
                            </ul>
                            <button className="mt-8 bg-primary hover:bg-primary-hover text-white px-6 py-3 rounded-lg font-semibold text-base transition-colors">
                                Start getting paid
                            </button>
                        </div>
            ...
            <section className="bg-lightbg py-5 md:py-7" data-purpose="feature-right-text">
                <div className=" mx-auto px-4 sm:px-6">
                    <div className="flex flex-col md:flex-row gap-10 md:gap-16 items-center">
                        ...
                        <div className="flex-1 order-1 md:order-2">
                            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-dark leading-tight tracking-tight">Easily generate and send invoices</h2>
                            <p className="text-slate-600 mb-8 text-lg leading-relaxed">Customize every detail. Add your logo, change colors to match your brand, and personalize the thank you message.</p>
                            <ul className="space-y-6">
                                <li className="flex gap-4 group">
                                    <div className="shrink-0 w-12 h-12 rounded-2xl bg-primary/10 flex items-center justify-center text-primary group-hover:scale-110 transition-transform">
                                        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg>
                                    </div>
                                    <div>
                                        <h4 className="font-bold text-slate-900 text-lg">AI Smart Editor</h4>
                                ...
                                <li className="flex gap-4 group">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-slate-900 text-lg">Instant Sync</h4>
