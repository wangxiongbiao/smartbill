...
export function FAQ() {
    ...
    return (
        <section className="bg-lightbg py-7 md:py-10" data-purpose="faq">
            <div className="max-w-3xl mx-auto px-4 sm:px-6">
                <div className="text-center mb-10">
                    <h2 className="text-2xl md:text-3xl font-bold text-dark">Your questions, answered</h2>
                </div>
                <div className="space-y-3">
                    {faqs.map((faq, index) => (
                        <details key={index} className="group bg-white rounded-lg shadow-sm">
                            <summary className="flex justify-between items-center font-medium cursor-pointer list-none px-5 py-4">
                                <span className="text-base text-gray-800 font-semibold">{faq.question}</span>
                            ...
                            <div className="text-gray-500 px-5 pb-5 text-sm leading-relaxed">
                                {faq.answer}
                            </div>
                        </details>
                    ))}
