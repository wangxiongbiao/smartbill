            ...
            <footer className="bg-slate-50 border-t border-slate-200 pt-16 pb-12">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
                        ...
                        <div className="md:col-span-2 space-y-6"><h4 className="text-xs font-black uppercase tracking-[0.3em] text-slate-400">Product</h4><ul className="space-y-4 text-sm font-bold text-slate-600"><li><Link href="/dashboard" className="hover:text-blue-600 transition-colors">Dashboard</Link></li><li><Link href="/dashboard?view=editor" className="hover:text-blue-600 transition-colors">Make Invoice</Link></li><li><Link href="/dashboard?view=templates" className="hover:text-blue-600 transition-colors">Templates</Link></li><li><Link href="/dashboard?view=editor" className="text-blue-600/60 hover:text-blue-600 transition-colors flex items-center gap-2"><i className="fas fa-bolt text-[10px]"></i> AI Assistant</Link></li></ul></div>
                        <div className="md:col-span-2 space-y-6"><h4 className="text-xs font-black uppercase tracking-[0.3em] text-slate-400">Support</h4><ul className="space-y-4 text-sm font-bold text-slate-600"><li><Link href="/dashboard?view=about" className="hover:text-blue-600 transition-colors">About Us</Link></li><li><Link href="/dashboard?view=help" className="hover:text-blue-600 transition-colors">Help Center</Link></li></ul></div>
