...
const RecordsView: React.FC<RecordsViewProps> = ({ records, onEdit, onDelete, onExport, lang }) => {
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-1.5">
                  ...
                  <span className={`px-2.5 py-0.5 rounded-full text-[10px] font-black uppercase tracking-widest ${
                    record.type === 'invoice' ? 'bg-indigo-50 text-indigo-600' : 'bg-emerald-50 text-emerald-600'
                  }`}>
                    {record.type}
                  </span>
                </div>
