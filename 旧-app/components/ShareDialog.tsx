...
const ShareDialog: React.FC<ShareDialogProps> = ({ invoice, isOpen, onClose, lang }) => {
    ...
    // Fetch existing shares when dialog opens - logic placeholder if we were fetching list
    // Currently we just reset specific transient states
    // In a real app we might fetch existing shares for this invoice here
